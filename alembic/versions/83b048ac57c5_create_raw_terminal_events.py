...
def upgrade() -> None:
    ...
    op.create_index('idx_raw_terminal_events_captured_at', 'raw_terminal_events', ['captured_at'])
    op.create_index('idx_raw_terminal_events_session_id', 'raw_terminal_events', ['session_id'])
