...
from omega_kg.models.raw_storage import RawConversation, RawIngestion, _RAW_INGESTION_AVAILABLE
...
async def init_db():
    ...
    async with engine.begin() as conn:
        ...
        if raw_ingestions_exists:
            ...
            logger.warning("⚠ raw_ingestions table not found. Run InGest-LLM migrations first:")
