...
class SmokeTest:
    ...
    def test_env_vars(self):
        ...
        optional = ['LINEAR_API_KEY', 'LINEAR_TEAM_ID', 'EXTENSION_API_KEY', 'JWT_SECRET_KEY']
    ...
    def test_vault_utils(self):
        ...
        try:
            ...
            assert hasattr(vault, 'find_note_by_linear_id'), "Missing find_note_by_linear_id method"
    ...
    def test_smart_parser(self):
        ...
        try:
            ...
            assert hasattr(parser, 'sync_note_to_linear'), "Missing sync_note_to_linear method"
    ...
    def test_html_parsing(self):
        ...
        try:
            ...
            result = parse_html_content(ai_studio_html, "https://aistudio.google.com/chat")
    ...
    def test_auth_utils(self):
        ...
        try:
            ...
            # Test token creation
            token = create_access_token({"sub": "test_user"}, expires_delta=timedelta(minutes=15))
    ...
    def test_webhook_handler(self):
        ...
        try:
            ...
            assert hasattr(sync, 'handle_linear_webhook_request'), "Missing webhook handler"
