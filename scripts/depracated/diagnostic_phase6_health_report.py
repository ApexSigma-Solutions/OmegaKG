...
async def generate_health_report():
    ...
    try:
        ...
        try:
            ...
            report["recommendations"].append("Fix PostgreSQL connection before proceeding")
    ...
    code_checks = {
        ...
        "embedding_service_exists": Path("omega_kg/domain/common/embedding_service.py").exists(),
    }
    ...
    try:
        ...
        async with AsyncSessionLocal() as session:
            ...
            print(f"Unprocessed with errors: {report['checks']['error_handling']['unprocessed_errors']}")
    ...
    report["summary"] = {
        ...
        "status": "HEALTHY" if health_percentage >= 80 else "NEEDS_ATTENTION" if health_percentage >= 50 else "CRITICAL",
    }
