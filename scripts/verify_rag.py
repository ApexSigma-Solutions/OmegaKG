...
DB_URL = "postgresql+asyncpg://omega_user:omega_dev_password@127.0.0.1:5800/omega_kg_stable"
...
async def test_retrieval():
    ...
    if results:
        ...
        for idx, res in enumerate(results):
            ...
            print(f"   Context: {content[:150].replace(chr(10), ' ')}...") # Flatten newlines
            print("-" * 60)
    else:
        print("\n⚠️  FAILURE: No results found.")
        print("   - Check if vectors were written (SQL: SELECT count(*) FROM omega_vectors_1024)")
