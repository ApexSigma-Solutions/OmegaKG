...
class TestTableCreation:
    ...
    def test_table_has_id_column(self, mock_create_table):
        ...
        id_col = next((col for col in columns if hasattr(col, 'name') and col.name == 'id'), None)
    ...
    def test_table_has_message_id_column(self, mock_create_table):
        ...
        columns = mock_create_table.call_args[0][1:]
        msg_id_col = next((col for col in columns if hasattr(col, 'name') and col.name == 'message_id'), None)
    ...
    def test_table_has_embedding_column(self, mock_create_table):
        ...
        columns = mock_create_table.call_args[0][1:]
        embedding_col = next((col for col in columns if hasattr(col, 'name') and col.name == 'embedding'), None)
    ...
    def test_table_has_status_column_with_default(self, mock_create_table):
        ...
        columns = mock_create_table.call_args[0][1:]
        status_col = next((col for col in columns if hasattr(col, 'name') and col.name == 'status'), None)
    ...
    def test_table_has_retry_count_column(self, mock_create_table):
        ...
        columns = mock_create_table.call_args[0][1:]
        retry_col = next((col for col in columns if hasattr(col, 'name') and col.name == 'retry_count'), None)
    ...
    def test_table_has_timestamp_columns(self, mock_create_table):
        ...
        columns = mock_create_table.call_args[0][1:]
        created_col = next((col for col in columns if hasattr(col, 'name') and col.name == 'created_at'), None)
        updated_col = next((col for col in columns if hasattr(col, 'name') and col.name == 'updated_at'), None)
...
class TestTableConstraints:
    ...
    def test_primary_key_constraint_exists(self, mock_create_table):
        ...
        pk_constraint = next((arg for arg in all_args if isinstance(arg, sa.PrimaryKeyConstraint)), None)
    ...
    def test_status_check_constraint_exists(self, mock_create_table):
        ...
        all_args = mock_create_table.call_args[0]
        check_constraint = next((arg for arg in all_args if isinstance(arg, sa.CheckConstraint)), None)
...
class TestIndexCreation:
    ...
    @patch('alembic.op.create_table')
    @patch('alembic.op.execute')
    def test_message_id_index_created(self, mock_execute, mock_create_table, mock_create_index):
    ...
    @patch('alembic.op.create_table')
    @patch('alembic.op.execute')
    def test_status_index_created(self, mock_execute, mock_create_table, mock_create_index):
    ...
    @patch('alembic.op.create_table')
    @patch('alembic.op.execute')
    def test_pending_partial_index_created(self, mock_execute, mock_create_table, mock_create_index):
    ...
    @patch('alembic.op.create_table')
    @patch('alembic.op.execute')
    def test_cleanup_index_created(self, mock_execute, mock_create_table, mock_create_index):
    ...
    @patch('alembic.op.create_table')
    @patch('alembic.op.execute')
    def test_failed_retry_index_created(self, mock_execute, mock_create_table, mock_create_index):
        ...
        index_calls = [call[0] for call in mock_create_index.call_args_list]
        assert any('idx_omega_vectors_failed_retry' in str(call) for call in index_calls)

    @patch('alembic.op.create_index')
    @patch('alembic.op.create_table')
    @patch('alembic.op.execute')
    def test_correct_number_of_indexes_created(self, mock_execute, mock_create_table, mock_create_index):
...
class TestMigrationPerformance:
    ...
    @patch('alembic.op.create_table')
    @patch('alembic.op.execute')
    def test_partial_indexes_use_where_clause(self, mock_execute, mock_create_table, mock_create_index):
        ...
        partial_index_count = sum(
            1 for call in mock_create_index.call_args_list
