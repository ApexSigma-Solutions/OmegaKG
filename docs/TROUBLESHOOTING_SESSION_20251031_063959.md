...
- **Problem**: DOM selectors changed, messagesFound: 0
- **Old selectors**: 
  - Container: [role="main"]
  - User: [data-blocks-role="chat-history"] [data-blocks-role="message"][data-message-role="user"]
  - Assistant: [data-blocks-role="chat-history"] [data-blocks-role="message"][data-message-role="model"]
- **New selectors** (updated in content.js):
  - Container: main
...
- **Fix**: Added https://chatgpt.com/* to manifest.json host_permissions and content_scripts
