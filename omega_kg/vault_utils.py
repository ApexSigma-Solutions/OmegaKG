...
class VaultUtils:
    ...
    def read_note_frontmatter(self, note_path: str | Path) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Failed to read or parse frontmatter from {resolved_path}: {e}")
            return {}


    def update_note_frontmatter(self, note_path: str | Path, updates: Mapping[str, Any]) -> bool:
        """
