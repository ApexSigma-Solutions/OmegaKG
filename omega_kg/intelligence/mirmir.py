...
class Mirmir:
    ...
    def review_action(
        ...
        for constraint in constraints:
            ...
            if evaluation == "violate":
                ...
                logger.warning(f"⚠️  Violation: {constraint.id} - {constraint.description}")
    ...
    def _get_relevant_constraints(self, context_tags: List[str] = None) -> List[Constraint]:
        """
        ...
        for context in context_tags:
            try:
                ...
                logger.warning(f"Failed to get constraints for context '{context}': {e}")
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        stop_words = {
            ...
            "should", "may", "might", "must", "shall", "can", "need", "to",
