...
class Constraint(BaseModel):
    ...
    severity: SeverityLevel = Field(default=SeverityLevel.WARNING, description="Severity level")
    created_at: Optional[datetime] = Field(default=None, description="Creation timestamp")
    contexts: List[str] = Field(default_factory=list, description="Contexts this constraint governs")
...
class Incident(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=datetime.utcnow, description="When the incident occurred")
...
class Verdict(BaseModel):
    ...
    constraints_checked: List[str] = Field(default_factory=list, description="IDs of constraints checked")
    violations: List[str] = Field(default_factory=list, description="IDs of violated constraints")
    warnings: List[str] = Field(default_factory=list, description="IDs of constraints with warnings")
